...
<head>
    ...
    <title>GadgetKita — @yield('title')</title>
...
<nav class="navbar">
    <div class="container-xl px-4 d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                <span class="brand-name">Gadget<em>Kita</em></span>
                <div class="brand-sub">ELECTRONICS & GADGET STORE</div>
            </div>
        </div>
        <div class="d-flex align-items-center gap-3">
            <span class="nav-right">{{ auth()->user()->name ?? '' }}</span>
